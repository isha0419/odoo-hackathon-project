...
def transition(
    ...
    valid = False
    if old_status == MaintenanceStatus.PENDING and new_status in (MaintenanceStatus.APPROVED, MaintenanceStatus.REJECTED):
        valid = True
        ...
        valid = True
    elif old_status == MaintenanceStatus.TECHNICIAN_ASSIGNED and new_status == MaintenanceStatus.IN_PROGRESS:
        valid = True
    elif old_status == MaintenanceStatus.IN_PROGRESS and new_status == MaintenanceStatus.RESOLVED:
        valid = True
